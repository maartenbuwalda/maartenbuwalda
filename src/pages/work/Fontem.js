...
export const Fontem = (
  <>
    ...
    <section>
      <h3>My role</h3>
      <p>The acceleration program works in a very start-up way, which means that my role has been very flexible. I started out by having responsibility over forms on the website, like registration and login. After this was mostly done, I switched to SEO. I expect to be doing many different things for this project and learn a lot.</p>
    </section>
    <section>
